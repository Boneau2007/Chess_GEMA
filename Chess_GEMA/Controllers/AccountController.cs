...
namespace Chess_GEMA.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // Erstellt ein Objekt für unseren ApplicationDBContext
        ...
        {
            //ViewBag.Name = new SelectList(_context.Roles.Where(u => u.Name.Contains("User"))
            //    .ToList(), "Name", "Name");
        ...
        //Gibt Kontakt bei eingegebenem String
        // GET: Account/GetById/{userId}
        [AllowAnonymous]
        public ActionResult GetById(string UserName)
        {
            var contact = _context.Users.SingleOrDefault(i => i.UserName.Equals(UserName));
